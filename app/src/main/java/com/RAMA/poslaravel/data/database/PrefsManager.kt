package com.lazday.poslaravel.data.database
...
class PrefsManager (context: Context) : Krate {
    ...
    init {
        sharedPreferences = context.applicationContext.getSharedPreferences (
            "pos_android_prefs", Context.MODE_PRIVATE
        )
    }

    var prefsOnBoarding by booleanPref(PREFS_ON_BOARDING, false)
